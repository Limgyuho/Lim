...
<div id="approvedMembers" class="tab-content ">
    <div class="flex">
        ...
        <div class="flex ">총 인원: ${memberCnt} 명</div>
            <button class="btn btn-active" type="button" onclick="transferSelected()" id="transferButton" disabled>인사이동</button>
 			<button class="/usr/admin/deleteMembers">멤버 탈퇴</button>
    </div>

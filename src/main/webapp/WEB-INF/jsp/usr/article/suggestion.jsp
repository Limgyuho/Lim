								...
								<tbody>
									<tr height="145">
										...
										<td>부서 : ${rq.getLoginedMember().getDepartment()} 직급 :
											...
											${rq.getLoginedMember().getName()}</td>
									</tr>
									<tr>
										<th>사무용품 교체,요청</th>
										<td>
											<div>
												<span>모니터 교체 신청</span><input name="item" value="모니터"
													type="checkbox" class="checkbox checkbox-accent" /> <span>pc
													교체 신청</span> <input name="item" value="pc" type="checkbox"
													class="checkbox checkbox-accent" /> <span>의자 교체 신청</span>
												<input name="item" value="의자" type="checkbox"
													class="checkbox checkbox-accent" /> <span>책상 교체 신청</span>
												<input name="item" value="책상" type="checkbox"
									...
									<tr>
										...
										<td>
											<div>
												<span>스타렉스</span> <input value="스타렉스" name="item"
													type="checkbox" class="checkbox checkbox-accent" /> <span>제네시스
												</span><input value="제네시스" name="item" type="checkbox"
													class="checkbox checkbox-accent" /> <span>포터</span> <input
													value="포터" name="item" type="checkbox"
													class="checkbox checkbox-accent" />
											</div>
										</td>
									</tr>

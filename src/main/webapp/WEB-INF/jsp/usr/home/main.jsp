...
<div class="flex border-red m-16">
	<div class="border-black m-10 ">
		<div class="bg-blue-200 text-3xl p-10 rounded-full flex justify-center items-center">
			<a href="/usr/article/ministry">
				협력
				<br />
				부처
			</a>
	...
	<div class="border-black m-10 ">
		<div class="bg-blue-200 text-3xl p-10 rounded-full  flex justify-center items-center">
			<a href="/usr/article/organization">
			    조직
			    <br />
			    안내
		    </a>
...
<div class="flex  border-red m-16">
	<div class=" border-black m-10">
	    <div class="flex px-10 w-full ">
	        <button class="  bg-gray-300  rounded-l-full px-10 py-5 hover:bg-blue-200" onclick="showTab('member')">인사이동대상자</button>
	        <button class="  bg-gray-300  px-10 py-5 hover:bg-blue-200" onclick="showTab('suggestion')">건의/요청사항</button>
	        <button class="  bg-gray-300  px-10 py-5 hover:bg-blue-200" onclick="showTab('program')">필수프로그램</button>
	        <button class="  bg-gray-300  rounded-r-full px-10 py-5 hover:bg-blue-200" onclick="showTab('vacation')">휴가신청현황</button>
	    </div>
	    <br />
	...
	<div class="flex justify-end  m-10 px-10 ">
